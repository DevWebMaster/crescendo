...
class Category extends My_Controller {
  ...
  public function get_category_list()
  {
    ...
    $totalRecords = $this->category_model->get_category_all_count();
    $totalRecordwithFilter = $this->category_model->get_category_all_count_with_filter($filter_name, $filter_status, $start, $rowperpage);
    $point_list = $this->category_model->get_category_list($filter_name, $filter_status, $start, $rowperpage);
    ...
    foreach ($point_list as $value) {
        ...
        $data[] = array( 
          ...
          "action"=>'<div style="display: inline-flex;"><a id="'.$value['id'].'" class="mr-1 btn-sm btn btn-info edit-row" href="edit_category/'.$value['id'].'"><i class="fa fa-edit"></i></a><a id="'.$value['id'].'" class="mr-1 btn-sm btn btn-danger delete-row"><i class="fa fa-times"></i></a></div>'
       );
    }
  ...
  public function edit_category($id = 0)
  {
    ...
    $data['category_info'] = $this->category_model->get_category_info($id);
  ...
  public function save_category()
  {
    ...
    if($uploadOk == 1){
      $result = $this->category_model->save_category($category_name, basename($_FILES["imageToUpload"]["name"]), $status);
    }
