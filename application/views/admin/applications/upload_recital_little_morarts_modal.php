<!--------  modal ---------->	
<div class="modal fade" id="upload_recital_little_morarts" tabindex="-1" role="dialog" aria-labelledby="upload_little_morartsLabel">
<div class="modal-dialog modal-md" role="document">
<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title" id="upload_little_morartsLabel">Upload CSV File for Recital Little Mozarts:</h4>
	...
	$(document).ready(function(){
		$('#recitaluploadForm').submit(function(e) {
			...
			if($('#recitalfileToUpload').val()){
				...
				$.ajax({
					url: '<?= site_url(); ?>admin/applications/import_from_excel_recital_little_morarts',
					type: 'POST',
					data: formData,				
					cache: false,
					contentType: false,
					...
					success: function(response) {
						...
						if(result['status'] == 0){
							...
							// setTimeout(function(){ 
			    //               window.location.href = "<?php echo site_url('admin/applications/index'); ?>";
			    //             }, 3000);
						}else{
