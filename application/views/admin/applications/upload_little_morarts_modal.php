...
<div class="modal-content">
    <div class="modal-header">
        <h4 class="modal-title" id="upload_little_morartsLabel">Upload CSV File for Little Mozarts:</h4>
	...
	$(document).ready(function(){
		$('#uploadForm').submit(function(e) {
			...
			if($('#fileToUpload').val()){
				...
				$.ajax({
					url: '<?= site_url(); ?>admin/applications/import_from_excel_little_morarts',
					type: 'POST',
					data: formData,				
					cache: false,
					contentType: false,
