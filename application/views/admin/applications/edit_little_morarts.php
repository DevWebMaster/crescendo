                  ...
                  <div class="row" style="text-align: center;">
                    <div class="col-12 col-md-12">
                      <div class="form-group mt-4">
                        <input type="submit" class="btn btn-sm btn-info update_apply px-4" style="background: #EEA400; border: none; width: 30%;" value="Update">
  ...
  $(document).ready(function() {
    $('#uploadForm').submit(function(e) {
      ...
      if($('#score').val() && ($('#score').val().split('.')[1] == 0 || $('#score').val().split('.')[1] == 5)){
        ...
        $.ajax({
          url: '<?= site_url(); ?>admin/applications/update_apply',
          type: 'POST',
          data: formData,       
          cache: false,
          contentType: false,
