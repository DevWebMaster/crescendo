                  ...
                  <div class="row">
                    <div class="col-12 col-md-12">
                      <div class="form-group mt-4">
                        ...
                        <a type="button" style="width: 30%;" class="btn btn-sm btn-danger cancel px-4" id="cancel" href="<?= site_url(); ?>admin/applications/crescendo">Cancel</a>
                      </div>
                    </div>
                  </div>
              </form>
  ...
  $(document).ready(function() {
    $('#uploadForm').submit(function(e) {
      ...
      if($('#score').val() && ($('#score').val().split('.')[1] != 0 || $('#score').val().split('.')[1] != 5)){
        ...
        $.ajax({
          url: '<?= site_url(); ?>admin/applications/update_recital_crescendo_apply',
          type: 'POST',
          data: formData,       
          cache: false,
          contentType: false,
