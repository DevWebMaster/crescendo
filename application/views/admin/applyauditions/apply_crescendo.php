              ...
              <form method="post" enctype="multipart/form-data" id="uploadForm">
                <!-- <div class="card-body"> -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                      <div class="form-group flex-group mt-4">
                        <a type="button" style="border: none; border-radius: 16px; width: 100%;" class="btn btn-sm btn-danger cancel px-4 py-2" id="cancel" href="<?= site_url(); ?>admin/applyauditions/crescendo">Cancel</a>
                      </div>
                    </div>
                  </div>
                <!-- </div> -->
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#btn_confirm').click(function(){
      ...
      window.location.href = '<?= site_url(); ?>admin/applyauditions/apply_crescendo/'+audition_id;
    })
