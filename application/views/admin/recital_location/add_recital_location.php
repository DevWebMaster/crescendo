                  ...
                  <div class="row">
                    <div class="col-12 col-md-8">
                      <div class="form-group mb-2">
                        <input type="text" class="form-control form-control-sm" name="location" id="location" placeholder="Recital Location">
                      </div>
                    </div>
  ...
  $(document).ready(function() {
    $('#uploadForm').submit(function(e) {
      ...
      if($('#location').val()){
        ...
        $.ajax({
          url: '<?= site_url(); ?>admin/recital_location/save_location',
          type: 'POST',
          data: formData,       
          cache: false,
          contentType: false,
          ...
          success: function(response) {
            ...
            if(!result || result == 0){
              ...
              setTimeout(function(){
                window.location.href = '<?= site_url(); ?>admin/recital_location/index';
              }, 600);
            }
