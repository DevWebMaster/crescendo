          ...
          <div class="row">
            ...
            <div class="col-12 col-md-1 col-xs-12">
              <div class="form-group mt-4">
                <a class="btn add_new float-right" style="background: #EEA400; color: white;" id="add_new" href="<?= site_url(); ?>admin/recital_location/add_recital_location">Add New Recital</a>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-12">
              <div class="table-responsive px-1">  
                <table id='recital_location_list' class='table table-bordered table-striped text-center'>
                  <thead>
    ...
    <!--------  modal ----------> 
      ...
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="modal-title" id="edit_location_modalLabel">Edit Recital Center</h4>
              ...
              <div class="row">
                <div class="col-12 col-md-12">
                  <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" name="m_location" id="m_location" placeholder="Recital Location">
                  </div>
                </div>
              </div>
          </div><!--/body -->
...
<script type="text/javascript">
  $(document).ready(function(){
    init_recital_location_list(filter = '');

    $('#recital_location_list tbody').on('click', 'td a.delete-row', function(){
      var id = $(this).attr('id');  
      $.ajax({
        url: '<?= site_url(); ?>admin/recital_location/delete_recital_location',
        type: 'POST',
        data: {id: id},
    ...
    function init_recital_location_list(filter){
      $('#recital_location_list').DataTable({
        'destroy': true,
        'processing': true,
        // 'serverSide': true,
        'pagingType': "simple",
        'serverMethod': 'post',
        'ajax': {
            'url':'<?= site_url(); ?>admin/recital_location/get_recital_location_list',
            'data': { filter: filter }
        },
        'columns': [
           { data: 'id' },
    ...
    $('#recital_location_list tbody').on('click', 'td a.edit-row', function(){
    ...
    $('#btn_save').click(function(){
      ...
      $.ajax({
        url: '<?= site_url(); ?>admin/recital_location/update_location',
        type: 'POST',
