                ...
                <div class="card-body">
                  ...
                  <div id="online_video_section" style="display: none;">
                    <div class="row">
                      <div class="col-12 col-md-12">
                        <div class="form-group mb-2">
                          <label class="title">Video link:</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                      <div class="form-group mb-2">
                        ...
                        <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" title="'Enter accurate time of piece as this will be the allotted time allowed." style="color: white;"></i>
                      </div>
                    </div>
                  </div>
                  <div class="row">
