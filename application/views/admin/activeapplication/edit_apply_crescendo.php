              ...
              <form method="post" enctype="multipart/form-data" id="uploadForm">
                <!-- <div class="card-body"> -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-9">
                          <div class="form-group flex-group mb-2">
                            ...
                            <input style="width: 20%;" type="time" class="form-control form-control-sm ml-3 mt-1" name="request_time" id="request_time" value="<?= $crescendo[0]['request_time']; ?>">
                    ...
                    <div class="row">
                      <div class="col-12 col-md-12">
                        <div class="radio" style="display: flex; justify-content: space-between; padding-bottom: 8px;">
                          ...
                          <label>
                              <input type="radio" name="performance_type" id="ensemble" value="4" <?php if($crescendo[0]['performance_type'] == 4) { echo "checked"; } ?>>
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                          <div class="form-group flex-group mb-2">
                            ...
                            <i class="fa fa-info-circle pt-2" aria-hidden="true" data-toggle="tooltip" title="Enter the Paypal transaction."></i>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group flex-group mb-2">
                            ...
                            <input style="width: 65%;" type="number" class="form-control form-control-sm" name="paid_amount" id="paid_amount" value="<?= $crescendo[0]['paid_amount']; ?>">
                    ...
                    <div id="order_section">
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group flex-group mb-2">
                            <label class="title mr-2">Paid Amount:</label>
                            <input style="width: 65%;" type="number" class="form-control form-control-sm" name="order_paid_amount" id="order_paid_amount" value="<?= $crescendo[0]['paid_amount']; ?>">
                            <i class="fa fa-info-circle pt-2" aria-hidden="true" data-toggle="tooltip" title="Enter the Paid Amount."></i>
                          </div>
                        </div>
                        <div class="col-12 col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                      <div class="form-group flex-group mt-4">
                        <a type="button" style="border: none; border-radius: 16px; width: 100%;" class="btn btn-sm btn-danger cancel px-4 py-2" id="cancel" href="<?= site_url(); ?>admin/activeapplication/crescendo">Cancel</a>
                      </div>
                    </div>
                  </div>
                <!-- </div> -->
