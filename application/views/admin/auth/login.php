        ...
        <?php echo form_open(base_url('admin/auth/login'), 'class="login-form" '); ?>
          <div class="form-group has-feedback">
            <div class="input-container">
              ...
              <input type="text" name="email" id="email" class="form-control input-field" placeholder="Email" style="color: #FFFFFF !important; font-size: 17px; letter-spacing: 0.02em; font-weight: 500;">
            </div>
          </div>
          <div class="form-group has-feedback">
            <div class="input-container">
