                ...
                <div class="row pt-3 mb-2" style="background: #EEA400; color: white; border-radius: 8px; align-items: center;">
                  ...
                  <div class="col-md-4 col-xs-2">
                    <div class="form-group">
                      ...
                      <a href="<?= site_url(); ?>admin/applyrecital/apply_little_morarts/<?= $little_morart['id'] ?>" id="btn_apply" class="px-3 py-1 ml-5" style="background: white; color: #EEA400; border-radius: 8px;">Apply</a>
                    </div>
                  </div>
                </div>
              <?php endforeach; ?>
