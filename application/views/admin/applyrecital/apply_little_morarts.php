                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-9">
                        <div class="form-group flex-group mb-2">
                          <input style="width: 65%" type="text" readonly class="form-control form-control-sm" name="recital_name" id="recital_name" value="<?= $little_morart[0]['audition_name']; ?>">
                          <input type="hidden" name="recital_id" id="recital_id" value="<?= $little_morart[0]['id']; ?>">
                          <input type="hidden" name="ticket_price" id="ticket_price" value="<?= $little_morart[0]['ticket_price']; ?>">
                          <input type="hidden" name="discounted_price" id="discounted_price" value="<?= $little_morart[0]['discounted_price']; ?>">
                          <input type="hidden" name="discounted_quantity" id="discounted_quantity" value="<?= $little_morart[0]['discounted_quantity']; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-12 col-md-9">
                        <div class="form-group flex-group mb-2">
                          <input style="width: 65%" type="text" readonly class="form-control form-control-sm" name="recital_status" id="recital_status" value="<?= $little_morart[0]['is_active'] ? 'Open' : 'Close'; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-12 col-md-9">
                        <div class="form-group flex-group mb-2">
                          <input style="width: 65%;" type="text" readonly class="form-control form-control-sm" name="recital_location" id="recital_location" value="<?= $little_morart[0]['auditionlocation']; ?>">
                        </div>
                      </div>
                    </div>  
                    <div class="row">
                      ...
                      <div class="col-12 col-md-9">
                        <div class="form-group flex-group mb-2">
                          <input style="width: 65%;" type="text" readonly class="form-control form-control-sm" name="recital_status" id="recital_status" value="<?= $little_morart[0]['audition_date']; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-12 col-md-9">
                        <div class="form-group flex-group mb-2">
                          <input style="width: 65%" type="date" readonly class="form-control form-control-sm" name="recital_deadline" id="recital_deadline" value="<?= $little_morart[0]['audition_deadline']; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                          <div class="form-group flex-group mb-2">
                            <label class="title mr-2">Request Time:</label>
                              <input style="width: 20%;" readonly type="date" class="form-control form-control-sm" name="request_date" id="request_date" value="<?= $little_morart[0]['recital_date']; ?>">
                    ...
                    <div class="row">
                      <div class="col-12 col-md-12">
                        <div class="radio" style="display: flex; justify-content: space-around; padding-bottom: 8px;">
                          ...
                          <label>
                              <input type="radio" name="payment_type" id="order_check" value="2" checked="checked">
                              Money order/check
                          </label>
                        </div>
                      </div>
    ...
    $('#uploadForm').submit(function(e) {
      ...
      if($('#teacher_name').val() && $('#teacher_email').val() && $('#teacher_address').val() && $('#teacher_mobile_no').val() && $('#student_name').val() && $('#student_email').val() && $('#student_address').val() && $('#student_mobile_no').val() && $('#student_birthday').val() && $('#student_birthday').val().split('-')[0] < 2050 && $('#student_birthday').val().split('-')[0] > 1950 && $('#composer').val() && $('#title').val() && $('#student_time').val()){
        if($('#paypal').is(':checked') && ($('#transaction_date').val().split('-')[0] < 1950 || $('#transaction_date').val().split('-')[0] > 2050)){
          ...
          // $.ajax({
          //   url: '<?= site_url(); ?>admin/applyrecital/save_little_morarts',
          //   type: 'POST',
          //   data: formData,       
          //   cache: false,
          //   contentType: false,
          ...
          //       setTimeout(function(){
          //         window.location.href = '<?= site_url(); ?>admin/recitalhistory/index';
          //       }, 600);
          //     }
