              ...
              <div class="row">
                <div class="col-12 col-md-4">
                  <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" name="benefit_name" id="benefit_name">
                  </div>
                </div>
                <div class="col-12 col-md-4">
                  <div class="form-group mb-2">
            ...
            <div class="card-footer">
              <div class="col-12 col-md-2 offset-10">
                <div class="form-group mt-4">
                  <input type="submit" class="btn btn-sm btn-info add_benefits px-4" value="Add">
                  <a type="button" class="btn btn-sm btn-danger cancel px-4" id="cancel" href="<?= site_url(); ?>admin/benefits/index">Cancel</a>
                </div>
              </div>
            </div>
            </form>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#uploadForm').submit(function(e) {
      e.preventDefault();
      if($('#benefit_name').val() && $('#imageToUpload').val()){
        var formData = new FormData(this);
        $.ajax({
          url: '<?= site_url(); ?>admin/benefits/save_benefits',
          type: 'POST',
          data: formData,       
          cache: false,
          contentType: false,
